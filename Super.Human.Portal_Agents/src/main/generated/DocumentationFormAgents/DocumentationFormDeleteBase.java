...
/**
 * Generated Code
 * Update {@link DocumentationFormDelete} instead, so that this class can be replaced if necessary.
 */
public class DocumentationFormDeleteBase extends DeleteAgentBase {
